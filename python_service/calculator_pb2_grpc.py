...
class AdditionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                '/org.example.AdditionService/Add',
...
def add_AdditionServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'org.example.AdditionService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('org.example.AdditionService', rpc_method_handlers)
...
class MultiplicationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Multiply = channel.unary_unary(
                '/org.example.MultiplicationService/Multiply',
                request_serializer=calculator__pb2.CalculationRequest.SerializeToString,
                response_deserializer=calculator__pb2.CalculationResponse.FromString,
                _registered_method=True)
...
def add_MultiplicationServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'org.example.MultiplicationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('org.example.MultiplicationService', rpc_method_handlers)
